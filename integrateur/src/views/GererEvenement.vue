  ...
  <div class="page-gerer-evenements">
    ...
    <main class="main-content">
      <div class="gerer-evenements" v-if="isLogedIn">
        ...
        <div v-else>
          <p>Aucun événement trouvé. <router-link to="/creer-evenement" class="cta-button">Créez un
              événement</router-link></p>
        </div>
      </div>
...
function ajouterEtiquettes(event) {
  // Stocker l'événement à modifier dans le ModifierEvenementManager.js
  setEvenementAModifier(event);

  // Rediriger l'utilisateur vers la page d'ajout d'étiquettes
  router.push({ name: 'AjouterEtiquettes' });
}
